...
let fullDomain = location.host.split(":")[0].split(".");
let rootDomain = fullDomain.slice(fullDomain.length - 2, fullDomain.length).join(".");
let host = `${location.protocol}//${rootDomain}:4000/`;
